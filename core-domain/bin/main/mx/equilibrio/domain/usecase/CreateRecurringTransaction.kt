...
/**
 * Da de alta una plantilla de transacción recurrente (renta, suscripción,
 * nómina) y dispara de inmediato la materialización de su primera ocurrencia
 * vía [GenerateDueRecurringTransactions]. Una serie recurrente nunca puede
 * apuntar a una cuenta CREDIT_CARD (ver mensaje del `require`): ese caso ya
 * lo resuelve una compra a meses, no una recurrencia genérica.
 */
