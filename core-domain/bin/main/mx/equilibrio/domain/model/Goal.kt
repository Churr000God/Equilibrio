...
data class Goal(
    ...
    // Clamped a 0..1: un abono que sobrepase la meta no debe mostrar más de 100%.
    ...
    // Completada por estado explícito o porque ya se alcanzó el monto aunque el status todavía no se haya actualizado.
