...
/**
 * Arma una transferencia entre dos cuentas propias como un par de
 * transacciones ligadas (egreso en origen, ingreso en destino) que
 * [TransferRepository] persiste de forma atómica. Solo aplica entre cuentas
 * CASH/BANK: una tarjeta de crédito no participa de una transferencia normal
 * (ver [SaveTransaction], que bloquea el gasto directo contra CREDIT_CARD, y
 * `SaveCreditPurchase` para el camino que sí aplica a tarjetas).
 */
